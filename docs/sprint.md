...
- **진행: Sprint 36 (2026-07-10~13)** — E2E 정량 지표: 평가셋 42문항 고도화(등급 일치 100%·인용 100%·인용 키워드 100%·금지 0) + judge 진단축 + 사용자 데이터 테스트지(경계 페르소나 16명, 조인 무결성) + insurer 변경 버그 수정. pytest 1114
...
## ▶ 현재 작업 — Sprint 36: E2E 정량 지표 (LLM-as-judge) ✅ (커밋 대기)
