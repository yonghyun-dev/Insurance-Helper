...
const SOURCES: Source[] = [
  ...
  },
  {
    ...
    operator: '법제처',
    description:
      '보험업법·상법·자동차손해배상보장법 등 청구 관련 법령을 인용합니다. 법령 본문은 공공저작물로 자유 이용이 가능합니다.',
    meta: [
      { label: '활용 법령', value: '보험업법, 상법(보험편), 자동차손해배상보장법, 약관규제법' },
  ...
  },
  {
    kind: 'standard',
    tag: '표준',
    title: '손해보험협회 표준 과실비율 인정기준',
    operator: '손해보험협회 (KIDI)',
    description:
      '자동차 사고의 과실 비율 산정에 사용되는 손해보험협회 공식 표준입니다. 본 서비스는 정적 데이터셋을 적재하여 사용합니다.',
    meta: [
      { label: '법적 근거', value: '금감원 보험업감독업무 시행세칙 별표 15 (자동차보험 표준약관 별표 3)' },
      { label: '갱신 주기', value: '정적 데이터셋, 연 단위' },
    ],
    externalLink: { href: 'https://accident.knia.or.kr/standard', label: '손해보험협회 과실비율 인정기준' },
  },
  {
    kind: 'disease',
    tag: '진단코드',
  ...
  },
  {
    ...
    meta: [
      { label: '용도', value: '보험금 산정, 과실비율 적용, 한도 비교' },
